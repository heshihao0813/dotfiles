    ...
    htmlExport({ offline = false, runAllCodeChunks = false, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!offline &&
                ...
                fs
                    .createReadStream(path.resolve(extensionDirectoryPath, "./dependencies/reveal/plugin/notes/notes.js"))
                    .pipe(fs.createWriteStream(path.resolve(depsDirName, "notes.js")));
                fs
                    .createReadStream(path.resolve(extensionDirectoryPath, "./dependencies/reveal/plugin/notes/notes.html"))
