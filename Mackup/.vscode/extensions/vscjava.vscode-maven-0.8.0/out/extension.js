...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        context.subscriptions.push(vscode_extension_telemetry_wrapper_1.TelemetryWrapper.registerCommand("maven.history", () => __awaiter(this, void 0, void 0, function* () {
            yield mavenProjectsTreeDataProvider.historicalGoals();
        })));
